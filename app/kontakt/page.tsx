...
export const metadata: Metadata = {
  title: 'Kontakt — ROBZEN',
  description: 'Sprechen Sie uns an. Wir beraten Sie neutral und ohne Verkaufsdruck.',
}
      ...
      <div className="mx-auto max-w-xl px-6 py-20">
        <div className="mb-10">
          ...
          <p className="text-muted">
            Sie haben Fragen oder möchten eine konkrete Beratung anfragen?
          ...
          >
            ...
            Schnell per WhatsApp schreiben
          </a>
        </div>
        <ContactForm />
      </div>
